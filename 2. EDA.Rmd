...
brain_data %>%
  ggplot(aes(x = Date)) +
  geom_line(aes(y = K_Sum, colour = "K_Sum"), linewidth = 1, alpha = 0.5) +
  geom_line(aes(y = Kp_Sum, colour = "Kp_Sum"), linewidth = 1, alpha = 0.5) +
  scale_color_manual(
    name = "Индекс",
    values = c("K_Sum" = "royalblue2", "Kp_Sum" = "orangered2"),
    labels = c("K_Sum" = "Иркутск", "Kp_Sum" = "Мировой")
  ) +
